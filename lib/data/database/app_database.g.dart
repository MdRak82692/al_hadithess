...
class Hadith extends DataClass implements Insertable<Hadith> {
  ...
  Hadith copyWithCompanion(HadithsCompanion data) {
    return Hadith(
      ...
      arDiacless:
          data.arDiacless.present ? data.arDiacless.value : this.arDiacless,
...
class $$BooksTableFilterComposer extends Composer<_$AppDatabase, $BooksTable> {
  ...
  ColumnFilters<int> get numberOfHadis => $composableBuilder(
      column: $table.numberOfHadis, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get abvrCode => $composableBuilder(
      column: $table.abvrCode, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get bookDescr => $composableBuilder(
      column: $table.bookDescr, builder: (column) => ColumnFilters(column));
...
class $$BooksTableOrderingComposer
  ...
  ColumnOrderings<String> get abvrCode => $composableBuilder(
      column: $table.abvrCode, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get bookDescr => $composableBuilder(
      column: $table.bookDescr, builder: (column) => ColumnOrderings(column));
...
class $$BooksTableAnnotationComposer
  ...
  GeneratedColumn<int> get numberOfHadis => $composableBuilder(
      column: $table.numberOfHadis, builder: (column) => column);
...
class $$ChaptersTableFilterComposer
  ...
  ColumnFilters<String> get hadisRange => $composableBuilder(
      column: $table.hadisRange, builder: (column) => ColumnFilters(column));
...
class $$ChaptersTableOrderingComposer
  ...
  ColumnOrderings<String> get hadisRange => $composableBuilder(
      column: $table.hadisRange, builder: (column) => ColumnOrderings(column));
...
class $$ChaptersTableAnnotationComposer
  ...
  GeneratedColumn<String> get hadisRange => $composableBuilder(
      column: $table.hadisRange, builder: (column) => column);
...
class $$HadithsTableFilterComposer
  ...
  ColumnFilters<String> get hadithKey => $composableBuilder(
      column: $table.hadithKey, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get hadithId => $composableBuilder(
      column: $table.hadithId, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get arDiacless => $composableBuilder(
      column: $table.arDiacless, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get gradeColor => $composableBuilder(
      column: $table.gradeColor, builder: (column) => ColumnFilters(column));
}
...
class $$HadithsTableOrderingComposer
  ...
  ColumnOrderings<String> get hadithKey => $composableBuilder(
      column: $table.hadithKey, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get hadithId => $composableBuilder(
      column: $table.hadithId, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get arDiacless => $composableBuilder(
      column: $table.arDiacless, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get gradeColor => $composableBuilder(
      column: $table.gradeColor, builder: (column) => ColumnOrderings(column));
}
...
class $$HadithsTableAnnotationComposer
  ...
  GeneratedColumn<String> get arDiacless => $composableBuilder(
      column: $table.arDiacless, builder: (column) => column);
  ...
  GeneratedColumn<String> get gradeColor => $composableBuilder(
      column: $table.gradeColor, builder: (column) => column);
}
...
typedef $$HadithsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $HadithsTable,
    Hadith,
    $$HadithsTableFilterComposer,
